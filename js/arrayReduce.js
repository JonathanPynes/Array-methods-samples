const arrayReduce = () => {
    ...
    console.log("array.reduce(reducer0): ", reduced0)
    ...
    console.log("array.reduce(reducer1): ", reduced1)
    ...
    console.log("array.reduce(reduced2): ", reduced2)
    ...
    console.log("array.reduce(reduced3): ", reduced3)
}